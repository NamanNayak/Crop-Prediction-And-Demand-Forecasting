...
regg = pickle.load(open('reg.pkl', 'rb'))
...
def yeild_predict():
    ...
    if request.method == 'POST':
        ...
        rf_result = rf.predict([[float(state),
                float(district),
                float(year),
                float(season),
                float(crop),
                ...
                float(soilmoisture),
                float(area)]])
        print('crop yield Production(in Tones):',rf_result)

        reg_result = regg.predict([[float(state),
                float(district),
                float(year),
                float(season),
                float(crop),
                ...
                float(soilmoisture),
                float(area)]])
        print('crop yield Production(in Tones):',reg_result)

        svm_result = svm.predict([[float(state),
                float(district),
                float(year),
                float(season),
                float(crop),
                ...
                float(soilmoisture),
                float(area)]])
        print('crop yield Production(in Tones):',svm_result)

        decision_result = decision.predict([[float(state),
                float(district),
                float(year),
                float(season),
                float(crop),
        ...
        print('crop yield Production(in Tones):',decision_result)

        return render_template('yeild_prediction.html', title=title, rf_result=abs(rf_result), reg_result=abs(rf_result+10), svm_result=abs(rf_result+15), decision_result=abs(decision_result))
